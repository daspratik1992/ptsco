...
<body>
                ...
                <div class="col-lg-8">
                    ...
                    <li><a href="services.html">Services</a>
                    	<ul>
                            ...
                            <li class="active"><a href="bigdata.html">Big data Analytics Practice & Consulting</a></li>
    ...
    <section>
    	<div class="abt_banner">
        	<img src="images/big_bg.jpg" alt="">
            <h2>Big Data Analytics & HADOOP Services  </h2>
		</div>
</section>
        	...
        	<div class="row">
            	<div class="service1">
                	<div class="col-xs-12 col-sm-12 col-md-12">
                    	<div class="abt_text">
                            <p>The growth and profitability of today’s businesses depend mostly on the way a company organizes, distributes and utilizes its data. </p>
                        </div>
                    </div>
                </div>
            </div>
 ...
 <section>
 	<div class="health_sec">
    	<div class="container">
        	<div class="row">
            	<div class="col-lg-12">
                	<h2>Big Data Analytics & HADOOP Services </h2>
                    <h3>Without proper data insights you cannot unlock the complete expansion potential of your business. At ProcureTechStaff, we believe in helping you leverage the advanced analytical capabilities from the cumulated data masses of your business.<br><br>

We have rich experience in providing Big Data and Data Analytics services for industries including, but not limited to:</h3>
                  </div> 
              </div>  
              ...
              <div class="row">
                   ...
                   <div class="row se_circle"> 
                   <div class="big_da">
                   		<h2>PTCS DATA WAREHOUSING & BUSINESS INTELLIGENCE SERVICES</h2>
                   </div> 
                       <div class="col-lg-3">
                            <div class="report">
                            	<h2>BL Reporting</h2>
                                <li>Executive Dashboards</li>
                                <li>Ranking Reports & Web Based Reports</li>
                                <li>Interactive Reporting & What-If Analysis</li>
                       ...
                       <div class="col-lg-3">
                            <div class="report">
                                ...
                                <li>Dashboard</li>
                                <li>KIPS & EPMS</li>
                                <li>Advanced Analytics Services</li>
                            </div>
                       </div> 
                       <div class="col-lg-3">
                            <div class="report">
                            	<h2>Enterprise Data Warehousing</h2>
                                <li>Data Warehouses & data Marts</li>
                       ...
                       <div class="col-lg-3">
                            <div class="report">
                            	<h2>Data Acquisition & Migration</h2>
                                <li>Data Sources</li>
                                <li>Cleanup & Transformation</li>
                                <li>ETL</li>
                            </div>
                       </div> 
                   </div>
