...
<body>
                ...
                <div class="col-lg-8">
                    ...
                    <li><a href="services.html">Services</a>
                    	<ul>
                            ...
                            <li class="active"><a href="hosting.html">Hosting & Administration</a></li>
    ...
    <section>
    	<div class="abt_banner">
        	<img src="images/hosting_bg.jpg" alt="">
            <h2>HOSTING & ADMINISTRATION</h2>
		</div>
</section>
        	...
        	<div class="row">
            	<div class="service1">
                	<div class="col-xs-12 col-sm-12 col-md-12">
                    	<div class="abt_text">
                            <p>Businesses Trust PTCS Web Hosting<br>Everything you need to build your website. Without the hassle. </p>
                        </div>
                    </div>
                </div>
            </div>
    	...
    	<div class="container">
        	<div class="row">
            	<div class="col-lg-12">
                    ...
                    <p>Create a professional website yourself: no expensive programmers or designers required!</p>
					<h2>Unlimited everything</h2>
                    <p>We don't set limits on your success: PTCS offers unlimited storage and bandwidth for shared web hosting plans.</p>
                    <h2>Secure & reliable email</h2>
                    <p>You get all the basic email accounts that you need, but if you want more, simply switch to our Business or Business Pro web hosting plans; & get our Exclusive cloud-based business grade solutions.</p>
                    <h2>Easy account & website access</h2>
                    <p>Our control panel and proprietary dashboard are simple to use, supported by tutorial videos and an extensive knowledgebase.<br>

Build your professional, fully functional website in minutes using our Website Builder.</p>
                </div>
            </div>
        </div>
    </div>
